    ...
    <>
      <div className="bg-white border border-gray-200 shadow-sm rounded-none mb-12 overflow-hidden" dir="ltr">
        <div className="px-8 py-6 bg-slate-50 border-b border-gray-200 flex justify-between items-center">
          <h3 className="text-lg font-bold tracking-wide text-slate-900">Séquence</h3>
        ...
        {optimisticImages.length === 0 ? (
          <div className="p-12 text-center text-gray-500 dark:text-gray-400">
            <p className="mb-4 text-lg">La page est actuellement vide.</p>
            <p className="text-sm">Ajoutez votre première image en utilisant le formulaire ci-dessous pour commencer.</p>
          </div>
        ) : (
                ...
                <div className="flex-shrink-0 w-48 h-32 bg-slate-100 border border-gray-200 shadow-sm overflow-hidden relative group flex justify-center items-center">
                  ...
                  {image.imageUrl.startsWith("blob:") && (
                    <div className="absolute inset-0 bg-white/70 flex items-center justify-center z-20 backdrop-blur-sm">
                       <span className="text-xs font-bold uppercase tracking-widest text-slate-900 animate-pulse">Téléchargement...</span>
                    </div>
                  )}
                </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-none overflow-hidden" dir="ltr">
        <div className="px-8 py-6 bg-slate-50 border-b border-gray-200">
          <h3 className="text-lg font-bold tracking-wide text-slate-900">Télécharger une nouvelle affiche</h3>
        </div>
        <div className="p-6">
          <div className="max-w-2xl">
            <form ref={formRef} action={handleAction} className="space-y-4">
              <div>
                <label htmlFor="imageFile" className="block text-sm font-bold tracking-wide text-slate-700">Fichier image</label>
              ...
              <div className="pt-4 flex justify-start">
                <button type="submit" className="inline-flex items-center px-6 py-3 font-bold tracking-wide text-white bg-slate-900 hover:bg-black focus:outline-none transition-all shadow-sm hover:shadow-md disabled:opacity-50 rounded-none uppercase flex-row">
